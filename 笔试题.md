...
func main(){
    ...
    inputStr := bufio.NewScanner(os.Stdin)
    ...
    for inputStr.Scan(){
        ...
        year, _ := strconv.Atoi(all[0])
        mon, _ := strconv.Atoi(all[1])
        day, _ := strconv.Atoi(all[2])
...
//         s := make(sortByScore, num)

//         for i := 0; i < num; i++{
//             fmt.Scan(&s[i].name, &s[i].score)
//         }
//         if n == 0 {
